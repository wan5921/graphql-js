...
[![Build Status](https://github.com/graphql/graphql-js/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/graphql/graphql-js/actions/workflows/ci.yml)
